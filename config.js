const ownerNumber = ["65996450169@s.whatsapp.net"] 
// mude somente o numero e não tire o @s.whatsapp.net

const OriginalOwner = '65996450169' 
...
+ 'FN:Meu criador^~^\n' 
+ 'ORG:Ian;\n' 
+ 'TEL;type=CELL;type=VOICE;waid=5565996450169:+55 65 996450169\n' 
+ 'END:VCARD'
